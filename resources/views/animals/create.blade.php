            ...
            <div class="col-8">
                ...
                <form action="{{route('animals.store')}}" method="POST" id="add-form">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-sm" type="text" placeholder="Specie dell'animale" aria-label="Specie dell'animale" name="species" id="species" required>
                    </div>

                    <div class="mb-3">
                        <label for="breed">Razza</label>
                        <input class="form-control form-control-sm" type="text" placeholder="Razza dell'animale (opzionale)" aria-label="Razza dell'animale (opzionale)" name="breed" id="breed">
                    </div>

                    <div class="mb-3">
                        <label for="image_url">URL Immagine</label>
                        <input class="form-control form-control-sm" type="text" placeholder="URL immagine dell'animale" aria-label="URL immagine dell'animale" name="image_url" id="image_url">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control form-control-sm" placeholder="Descrizione dell'animale" aria-label="Descrizione dell'animale" name="description" id="description"></textarea>
                    </div>
